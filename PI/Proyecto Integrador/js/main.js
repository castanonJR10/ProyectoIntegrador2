...
$(document).on('click', '#boton2', function(){
  ...
  (function(){
    ...
    const myQuestions = [
      ...
      {
        question: "Resolver Exponentes: (4)^20 * (4)^8",
        answers: {
          a: "4^-12",
          b: "4^28",
          c: "4^12"
      ...
      {
        question: "Resolver Exponentes: (8)^8 * (8)^8",
        answers: {
          a: "8^16",
          b: "8^64",
          c: "8^1"
      ...
      {
        question: "Resolver Exponentes: 12^7 / 12^13",
        answers: {
          a: "12^20",
          b: "1/12^20",
          c: "1/12^6"
      ...
      {
        question: "Resolver Exponentes: (452)^20 * (452)^9",
        answers: {
          a: "1/452^11",
          b: "452^11",
          c: "452^29"
      ...
      {
        question: "Resolver Exponentes: 10^53 / 10^40",
        answers: {
          a: "1/10^13",
          b: "10^93",
          c: "10^13"
  ...
  (function(){
    ...
    const myQuestions = [
      ...
      },
      {
        ...
        answers: {
          a: "Ángulos= 90°, 48.3° B= 3.3261m C= 3.7332m",
      ...
      {
        question: "Halla la medida de todos los ángulo interiores del triángulo si su hipotenusa mide 6m y su altura mide 4m",
        answers: {
      ...
      {
        question: "Discriminante: 3 + 4x + x² = 0",
        answers: {
          a: "R = 28",
          b: "R = 12",
          c: "R = 32"
      ...
      {
        question: "Discriminante: 2x² - 10x/3 + 4/3 = 0",
        answers: {
          a: "R = 4",
          b: "R = 8",
          c: "R = 5"
      ...
      {
        question: "Resolver con fórmula general: 3x² - 5x +2 = 0",
        answers: {
          a: "x=1, x=-2/3",
          b: "x=1, x=2/3",
          c: "x=-1, x=2/3"
      ...
      {
        question: "Resolver con fórmula general: x² + 11x = -24",
        answers: {
          a: "x=3, x=8",
          b: "x=-3, x=-8",
          c: "x=-3, x=8"
      ...
      {
        question: "Resolver con fórmula general: 12x - 4 + 9x² = 0",
        answers: {
          a: "x=1 , x=-1",
          b: "x=2/3 , x=-3/6",
          c: "x=2/3 , x=-2/3",
      ...
      {
        question: "Resolver con fórmula general: 6x² = x + 222",
        answers: {
          a: "x=37/6,  x=-6",
          b: "x=-37/6,  x=-6",
          c: "x=37/6,  x=4"
      ...
      {
        question: "Resolver con fórmula general: 12x - 7x² + 64 = 0",
        answers: {
          a: "x=-2/4, x=7",
          b: "x=-14/7, x=4",
          c: "x=-16/7, x=4"
      ...
      {
        question: "Resolver con fórmula general: -6m + 5m² - 11 = 0",
        answers: {
          a: "m=-1, m=11/5",
          b: "m=-3, m=-12/4",
          c: "m=3, m=12/4"
      ...
      {
        question: "Resolver con fórmula general: 7y² = 3600 - 2y²",
        answers: {
          a: "y=10, y=-15",
          b: "y=-20, y=20",
          c: "y=15, y=1/2"
      ...
      {
        question: "Resolver con fórmula general: 5m² = 1875 + 2m²",
        answers: {
          a: "m=6, m=-15",
          b: "m=25, m=-25",
          c: "m=20, m=20"
      ...
      {
        question: "Resolver con fórmula general: -2x + 12x - x² + 32 = 0",
        answers: {
          a: "x=5-√57, x=5+√57",
          b: "x=-6-√60, x=6+√60",
          c: "x=--5-√58, x=5+√58"
      ...
      {
        question: "Resolver con fórmula general: 3x² = 6x² + x - 4",
        answers: {
          a: "x=1, x=1/2",
          b: "x=-4/3, x=1",
          c: "x=-4/7, x=-1"
